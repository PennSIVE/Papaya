...
then
    ...
    java -jar lib/compiler.jar --warning_level QUIET --compilation_level SIMPLE_OPTIMIZATIONS --language_in=ECMASCRIPT6 --language_out ES5 --js build/papaya.js --js_output_file build/papaya-out.js
    rm build/papaya.js
